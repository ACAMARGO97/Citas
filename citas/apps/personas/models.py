...
class Personas(models.Model):
    ...
    tiposexo = models.ForeignKey(TablaMaestra, null=True, blank=True, on_delete=models.CASCADE)
    #tipodocumento = models.ForeignKey(TablaMaestra, null=True, blank=True, on_delete=models.CASCADE)
